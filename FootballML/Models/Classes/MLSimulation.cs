...
namespace FootballML.Models
{
    public class MLSimulation
    {
       ...
       public double accuracy;
        ...
        {
            //Call AzureML web service (API) with the ML experiment that predicts game results, based on the games entered on the DB.
        ...
        {
            //Create test games for ML experiment to predict winner.
            ...
            {
                //Add test games to the DB so they can be read by the Azure ML API.
        ...
        {
            //Load Azure ML prediction results.
